const menu = [
  {
    ...
    items: [
      ...
      { name: "نسكافيه", price: 7000, img: '/items/nescafe.jpg' },
  ...
  },
  {
    ...
    items: [
      { name: "سبانيش لاتيه (الأكثر مبيعاً)", price: 9000, img: '/items/spanishlate.jpg' },
      { name: "أيس كوفي ميكس", price: 7500, img: '/items/icecofmix.jpg' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "بسكويت يانسون (ثلاث قطع)", price: 3000, img: '/items/yansonbiscuit.jpg' },
